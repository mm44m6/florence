...
class XDFive extends StatelessWidget {
  XDFive({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
              ...
              child: Text.rich(
                TextSpan(
                  ...
                  children: [
                    TextSpan(
                      text:
                          'A Florence precisa de algumas \ninformações suas para que \npossamos te oferecer a experiência\nmais completa possível.\n\n',
                    ),
                    TextSpan(
                      text: 'Você aceita responder algumas perguntas?',
                      style: TextStyle(
            ...
            child: PageLink(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(width: 1.0, color: const Color(0xff2dc897)),
                ),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(159.2, 509.0),
            child: SizedBox(
              width: 58.0,
              child: Text(
                'Claro!',
          ...
          Transform.translate(
            offset: Offset(82.0, 549.0),
            child: Container(
              width: 212.0,
              height: 41.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(19.5),
                border: Border.all(width: 1.0, color: const Color(0xff50c878)),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(81.2, 558.0),
            child: SizedBox(
              width: 214.0,
              child: Text(
