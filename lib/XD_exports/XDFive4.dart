...
class XDFive4 extends StatelessWidget {
  XDFive4({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontFamily: 'Poppins',
                  fontSize: 17,
                  color: const Color(0x666974de),
                  letterSpacing: 0.47600000000000003,
                ),
            ...
            child: PageLink(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 88.0, 37.0),
                      size: Size(88.0, 37.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(26.0, 7.0, 30.0, 23.0),
                      size: Size(88.0, 37.0),
                      pinBottom: true,
                      fixedWidth: true,
                      fixedHeight: true,
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(28.5, 7.5, 32.0, 23.0),
                      size: Size(88.0, 37.0),
                      pinBottom: true,
                      fixedWidth: true,
                      fixedHeight: true,
