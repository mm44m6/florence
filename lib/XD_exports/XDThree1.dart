...
class XDThree1 extends StatelessWidget {
  XDThree1({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(4.5, 60.0, 274.0, 39.0),
                    size: Size(278.5, 99.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    fixedHeight: true,
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(114.5, 7.5, 46.0, 23.0),
                          size: Size(274.0, 39.0),
                          pinBottom: true,
                          fixedWidth: true,
                          fixedHeight: true,
                    ...
                    child: PageLink(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(70.0, 8.0, 134.0, 23.0),
                            size: Size(274.0, 39.0),
                            pinBottom: true,
                            fixedWidth: true,
                            fixedHeight: true,
